...
// CThreadSyncDlg 대화 상자



CThreadSyncDlg::CThreadSyncDlg(CWnd* pParent /*=nullptr*/)
	: CDialog(IDD_THREADSYNC_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CThreadSyncDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
